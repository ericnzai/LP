...
#https://gist.github.com/codergr33n/7c84a052aac954376d0c
...
Param(
  ...
  [string]$toBranchName,
  [string]$fromBranchTfsPath,
  [string]$toBranchTfsPath,
  [string]$dbUserName,
...
$server = [Microsoft.TeamFoundation.Client.TeamFoundationServerFactory]::GetServer($tfsUrl)
...
& $tf workspaces /Collection:$tfsUrl /owner:<useraccount>
