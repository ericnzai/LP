...
{
    public class GivenTheUserHasAccessToSomePosts : BaseGiven
    {
        ...
        public class WhenThePostsAreAllLiveAndTheUserIsGettingPostEntities : GivenTheUserHasAccessToSomePosts
        {
        ...
        public class WhenThePostsAreAllLiveAndTheUserIsGettingPostIds : GivenTheUserHasAccessToSomePosts
        {
            ...
            {
                var expectedPostIds = new List<int> {1, 2, 3, 4, 5, 6};
